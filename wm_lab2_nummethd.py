...
label1 = Label(text = "Длина стержня", font = "Arial 11")
label1.grid(row=0, column=0)
label2 = Label(text = "Время воздействия", font = "Arial 11")
label2.grid(row=1, column=0)
label3 = Label(text = "Шаг по t ", font = "Arial 11")
label3.grid(row=6, column=0)
label4 = Label(text = "Шаг по x ", font = "Arial 11")
...
entry7.grid(row=9, column=1, padx=5, pady=5)
...
entry9.grid(row=7, column=1, padx=5, pady=5)
